...
Me and my partner Saad were always on time and were able to properly tell each other which sections of the project we were able to cover. 

### 2. What were some challenges your group faced in this unit?

Due to the limited time frame, Saad and I had to discard several features, so we aimed to 

### 3. What were some of the highlights or achievements that you are most proud of in this project?

Utilizing the features that we learned about in class such as using a PostGreSQL backend, authenticating via GitHub and deploying via Railway.

### 4. Reflecting on your web development journey so far, how have you grown since the beginning of the course?

I feel much more capable of backend engineering, as well as authentication.

### 5. Looking ahead, what are your goals related to web development, and what steps do you plan to take to achieve them?

One of my goals might be to extend the final project, add those features that Saad and I proposed but couldn't in the time frame. Basically complete our original vision.
